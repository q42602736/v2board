...
class UserRoute
{
    public function map(Registrar $router)
    {
        $router->group([
            ...
            $router->get ('/plan/checkPurchaseEligibility', 'V1\\User\\PlanController@checkPurchaseEligibility');
            // Invite
            ...
            // Checkin
            $router->post('/checkin/checkin', 'V1\\User\\CheckinController@checkin');
            $router->get ('/checkin/status', 'V1\\User\\CheckinController@getStatus');
            $router->get ('/checkin/history', 'V1\\User\\CheckinController@getHistory');
            $router->get ('/checkin/config', 'V1\\User\\CheckinController@getConfig');
            $router->get ('/checkin/leaderboard', 'V1\\User\\CheckinController@getLeaderboard');
        });
    }
}
